            ...
            public void done(List<ParseUser> objects, ParseException e) {
                if (e==null )
                {
                    if (objects.size()>0)
                    {
                        ...
                        Toast.makeText(UsersListActivity.this, "No other user exists", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
            ...
            try {
                ...
                object.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if(e==null)
                        {
                            Toast.makeText(UsersListActivity.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            Toast.makeText(UsersListActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
